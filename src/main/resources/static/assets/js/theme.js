...
!(function (t, e) {
    ...
    var d = (function (i) {
                ...
                W = (function () {
                    function n(t) {
                        ...
                        ((this.years = { show: e.find(C).length, element: e.find(C), format: e.find(C).data(z) || s, label: { show: e.find(_).length, element: e.find(_), format: e.find(_).data(z) || m } }),
                            ...
                            (this.weeks = { show: e.find(x).length, element: e.find(x), format: e.find(x).data(z) || u, label: { show: e.find(M).length, element: e.find(M), format: e.find(M).data(z) || g } }),
                            (this.days = { show: e.find(D).length, element: e.find(D), format: e.find(D).data(z) || c, label: { show: e.find(N).length, element: e.find(N), format: e.find(N).data(z) || y } }),
                            (this.hours = { show: e.find(F).length, element: e.find(F), format: e.find(F).data(z) || h, label: { show: e.find(q).length, element: e.find(q), format: e.find(q).data(z) || v } }),
                            (this.minutes = { show: e.find(V).length, element: e.find(V), format: e.find(V).data(z) || f, label: { show: e.find(Q).length, element: e.find(Q), format: e.find(Q).data(z) || w } }),
        ...
        v =
            ((p.prototype.determineDirectionAndSmartEasing = function () {
    ...
    function p(t, e, n) {
        ...
        (this.target = t),
            ...
            (this.options = m({}, this.defaults, n)),
    ...
    var g,
        ...
        B =
            ((y = "script"),
                (g = j)("body").tooltip({ selector: '[data-toggle="tooltip"]', container: "body" }),
                g("body").popover({ selector: '[data-toggle="popover"]', container: "body" }),
                g(".toast").toast(),
                {
                    version: "1.2.0",
        ...
        W =
            ((S = "mrDropdownGrid"),
                ...
                (F = '[data-toggle="dropdown-grid"]'),
                (V = ".dropdown form"),
                (_ = L = ".dropdown-menu"),
                (R = "[data-dropdown-content]"),
                (M = ".navbar-nav"),
                (N = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)"),
                (q = "data-hover"),
                (Q = "data-dropdown-grid-hover"),
                (H = (function () {
                    function l(t) {
                        (this.ticking = !1),
                            (this.isActive = !1),
                    ...
                    return (
                        (t.getOptions = function () {
                                ...
                                if ((this.getParentMenu(), !this.element.disabled && !w(this.element).hasClass(x.DISABLED))) {
                                    ...
                                    if ((this.isSubmenu || l.clearMenus(), (this.isSubmenu || !e) && (this.isSubmenu || !n || !t || t.type !== D.MOUSE_LEAVE))) {
                                        ...
                                        var i = { relatedTarget: this.element },
                                            r = w.Event(D.SHOW, i);
                                        w(this.parent).trigger(r),
                                        r.isDefaultPrevented() ||
                                        ("ontouchstart" in document.documentElement && 0 === w(this.parent).closest(M).length && w(document.body).children().on("mouseover", null, w.noop),
                                            this.element.focus(),
                                            this.element.setAttribute("aria-expanded", !0),
                                            w(this.menu).toggleClass(x.SHOW),
                                            this.updatePosition(),
                                            (this.isActive = !0),
                                            w(this.parent).toggleClass(x.SHOW).trigger(w.Event(D.SHOWN, i)));
                                    }
                                }
                            }),
                            ...
                            (t.positionContent = function (t, e) {
                                ...
                                var n,
                                    i = W.getDimensionsFromElement(this.content).width;
                                if (this.isSubmenu) {
                                    this.getParentMenu();
                            ...
                            (t.addEventListeners = function () {
                                ...
                                this.hover &&
                                w(this.parent).on(D.MOUSE_ENTER + " " + D.MOUSE_LEAVE, function (t) {
                            ...
                            (l.clearMenus = function (s, t) {
                                ...
                                ((e = t && "object" == typeof t ? t : document.querySelectorAll(F)),
                                    B.forEach(e, function (t, e) {
                                        ...
                                        if ((s && "click" === s.type && (r.clickEvent = s), i)) {
                                            ...
                                            if (
                                                w(n).hasClass(x.SHOW) &&
                                                !(
                                                    (s && (("click" === s.type && /input|textarea/i.test(s.target.tagName)) || ("keyup" === s.type && 9 === s.which)) && w.contains(n, s.target)) ||
                                                    (s && "click" === s.type && (w.contains(i.content, s.target) || i.content.isSameNode(s.target)))
                                                )
                                            ) {
                                                var o = w.Event(D.HIDE, r);
                                                w(n).trigger(o),
                                                o.isDefaultPrevented() ||
                                                ("ontouchstart" in document.documentElement && w(document.body).children().off("mouseover", null, w.noop),
                                                    e.setAttribute("aria-expanded", "false"),
                                                    (i.isActive = !1),
                                                    w(a).removeClass(x.SHOW),
                                                    w(n).removeClass(x.SHOW).trigger(w.Event(D.HIDDEN, r)));
                                            }
                                        }
                                    }));
                            }),
                            ...
                            (l.dataApiKeydownHandler = function (t) {
                                if (
                                    (/input|textarea/i.test(t.target.tagName) ? (32 !== t.which && 27 === t.which) || !((40 !== t.which && 38 !== t.which) || w(t.target).closest(L).length) : P.test(t.which)) &&
                                    (t.preventDefault(), t.stopPropagation(), !this.disabled && !w(this).hasClass(x.DISABLED))
                                ) {
                ...
                w(document)
                    .on(D.KEYDOWN_DATA_API, F, H.dataApiKeydownHandler)
                    .on(D.KEYDOWN_DATA_API, L, H.dataApiKeydownHandler)
                    .on(D.CLICK_DATA_API + " " + D.KEYUP_DATA_API, H.clearMenus)
                    .on(D.CLICK_DATA_API, V, function (t) {
                        t.stopPropagation();
                    }),
                ...
                (w.fn[S] = H.jQueryInterface),
                (w.fn[S].Constructor = H),
                (w.fn[S].noConflict = function () {
    ...
    var U = (function (i) {
        ...
        return (
            i(window).on(n.LOAD_DATA_API, function () {
                ...
                (i.fn[t] = o.jQueryInterface),
                (i.fn[t].Constructor = o),
                (i.fn[t].noConflict = function () {
    ...
    var K = (function (i) {
                            ...
                            G(n, null, [
                                ...
                                },
                                {
                                    ...
                                    set: function (t) {
                                        !0 === t &&
                                        !1 === c &&
                                        B.forEach(n.instances, function (t, e) {
                                            e.init();
                                        }),
                                            (c = !0);
                                    },
        ...
        Y = (function (r) {
            ...
            var t = "mrFormEmail",
                ...
                w = { SENT: "sent" + e, LOAD_DATA_API: "load" + e + ".data-api", SUBMIT: "submit" },
                b = "data-loading-text",
                E = "Sending",
                A = "forms/mail.php",
                S = 5e3,
                        ...
                        (t.submitForm = function () {
                            ...
                            (t.ajaxSubmit = function () {
                                ...
                                t.push({ name: "url", value: window.location.href }),
                                    j.ajax({ context: this, data: t, dataType: "json", error: this.showFeedback, success: this.processResponse, type: "POST", url: this.action }),
                            ...
                            (t.initSubmitButton = function () {
                                return (
                                    this.submitButton || (this.submitButton = this.form.querySelector(p)),
                                        ...
                                        (this.loadingText = this.submitButton.getAttribute(b) || E),
                            ...
                            (t.processResponse = function (t) {
                                ...
                                i || this.showFeedback(t.status, t.message),
                                    console.log(t)
                                t.errorDetail && console.error(t.errorName || T, 0 === t.errorDetail.indexOf("{") ? JSON.parse(t.errorDetail) : t.errorDetail);
                            }),
                            (t.showFeedback = function (t, e, n) {
                                this.toggleFormLoading(!1),
                                    "object" == typeof t && t.statusText

                                        ? (clearTimeout(this.feedbackTimeout), (this.feedback.error.innerHTML = (n || e) + ': <em>"' +t.responseJSON.message + '" +</em> ' + " " +  + "  "), this.feedback.error.classList.remove(s))
            ...
            return (
                r(window).on(w.LOAD_DATA_API, function () {
                    ...
                    (r.fn[t] = O.jQueryInterface),
                    (r.fn[t].Constructor = O),
                    ...
                    (t.initFilters = function () {
                        ...
                        (t.initIsotope = function () {
                            ...
                            (this.options.itemSelector = u),
                                ...
                                (this.isotope = new O(this.element, this.options)),
    ...
    !(function (t) {
        if ("function" == typeof r) {
            ...
            var e = { disableParallax: /iPad|iPhone|iPod|Android/, disableVideo: /iPad|iPhone|iPod|Android/ };
    ...
    var X,
                ...
                return (
                    (t.initMap = function () {
                        ...
                        (t.createMarkers = function () {
                            var c = this;
                            (w.MARKER = { icon: { url: this.$element.attr(p) || w.MARKER_IMAGE_URL, scaledSize: new google.maps.Size(50, 50) }, title: o, optimised: !1 }),
                                this.markerElements.each(function (t, e) {
                                    ...
                                    if (((n = new google.maps.Marker(jQuery.extend({}, l, { map: c.map }))), o.length)) {
                                        var u = new google.maps.InfoWindow({ content: o.first().html(), maxWidth: parseInt(o.attr("data-max-width") || "250", 10) });
        ...
        At =
            ((tt = "mrOverlayNav"),
                ...
                (at = "body > div.navbar-container"),
                (ot = "body > div.navbar-container > nav[data-overlay]"),
                (st = "nav"),
                (lt = "[data-overlay]"),
                (ut = "img"),
                (ct = (function () {
    ...
    (ht = j),
        ...
        (wt = j)(document).on("hide.bs.tab", function (t) {
        ...
        return function (t, e) {
            ...
            return a < 0 || o <= a
                ? s
                    ? ""
                    : void 0
                : (n = r.charCodeAt(a)) < 55296 || 56319 < n || a + 1 === o || (i = r.charCodeAt(a + 1)) < 56320 || 57343 < i
                    ? s
                        ? r.charAt(a)
                        : n
                    : s
    ...
    var kt = (function (i) {
            ...
            var t = "mrReadingPosition",
                ...
                s = { LOAD_DATA_API: "load.mr.readingPosition.data-api", RESIZE: "resize", SCROLL: "scroll" },
        ...
        Ot = new l("a[data-smooth-scroll]", { speedAsDuration: !0, offset: j("body").attr("data-smooth-scroll-offset") || 0 }),
        jt = (function (s) {
                ...
                w = (function () {
                    ...
                    return (
                        (t.initWatcher = function (t) {
                            ...
                            var a = b.create(t, r);
                            a.lock();
                            var o = null !== this.stickyUntil ? b.create(this.stickyUntil, { bottom: -(a.height + r.top) }) : null;
                            (this.watcher = a),
                                (this.untilWatcher = o),
                                (this.navHeight = this.navHeight),
                            this.isNavElement && 0 === a.top && !this.navIsAbsolute && n.addClass(l),
                            ...
                            (t.onWatcherChange = function (t) {
                                t.toggleClass(l, this.watcher.isAboveViewport || (!this.navIsAbsolute && !this.stickBottom && this.isNavElement && 0 === this.watcher.top)),
                                    t.toggleClass(a, this.watcher.isAboveViewport && this.isNavElement && !this.stickBottom),
    ...
    var De,
        ...
        Be = Ft(function (t) {
            ...
            (t.exports = function (t, e, n, i) {
                var r = !!i && !!i.unsafe,
                    a = !!i && !!i.enumerable,
                    o = !!i && !!i.noTargetGet;
                "function" == typeof n && ("string" != typeof e || Xt(n, "name") || Yt(n, "name", e), (s(n).source = l.join("string" == typeof e ? e : ""))),
                    t !== Ht ? (r ? !o && t[e] && (a = !0) : delete t[e], a ? (t[e] = n) : Yt(t, e, n)) : a ? (t[e] = n) : Qt(e, n);
        ...
        Ue = Math.max,
        Ke = Math.min,
        Ye = { includes: Ie(!0), indexOf: Ie(!1) }.indexOf,
        ...
        vn = xe("iterator"),
        wn = !1;
    [].keys && ("next" in (Ve = [].keys()) ? (Fe = fn(fn(Ve))) !== Object.prototype && (De = Fe) : (wn = !0)),
    null == De && (De = {}),
    Xt(De, vn) ||
    Yt(De, vn, function () {
        return this;
    ...
    function bn() {}
    var En = { IteratorPrototype: De, BUGGY_SAFARI_ITERATORS: wn },
        An =
            Object.keys ||
            function (t) {
                return ke(t, Ze);
    ...
    de[In] = !0;
    function Cn(t, e, n) {
        t && !Xt((t = n ? t : t.prototype), Fn) && Dn(t, Fn, { configurable: !0, value: e });
    }
    function Pn() {
        return this;
    }
    ...
    !(function (t, e, n, i, r, a, o) {
        !(function (t, e, n) {
            var i = e + " Iterator";
            (t.prototype = jn(Ln, { next: qt(1, n) })), Cn(t, i, !1), (Vn[i] = Pn);
        })(n, e, i);
        function s(t) {
            if (t === r && p) return p;
        ...
        if (
            (g && ((l = fn(g.call(new t()))), Rn !== Object.prototype && l.next && (fn(l) !== Rn && (_n ? _n(l, Rn) : "function" != typeof l[Nn] && Yt(l, Nn, xn)), Cn(l, h, !0))),
            r == qn &&
            m &&
            m.name !== qn &&
            ((f = !0),
            ...
            if (((u = { values: s(qn), keys: a ? p : s("keys"), entries: s(Qn) }), o)) for (c in u) (!Mn && !f && c in d) || Be(d, c, u[c]);
            else Ce({ target: e, proto: !0, forced: Mn || f }, u);
    })(
        String,
        "String",
        function (t) {
            Bn(this, { type: zn, string: String(t), index: 0 });
        },
        function () {
            var t,
                e = Wn(this),
                n = e.string,
                i = e.index;
            return i >= n.length ? { value: void 0, done: !0 } : ((t = Hn(n, i)), (e.index += t.length), { value: t, done: !1 });
        }
    );
    function Gn(i, r, t) {
        if (
                ...
                return void 0 === t
                    ...
                    : null === t
                        ...
                        typeof (n = (function (t, e) {
                            ...
                            : ti
                                ? be(e)
                                : "Object" == (i = be(e)) && "function" == typeof e.callee
                                    ? "Arguments"
                                    : i;
            },
        ni = xe("iterator"),
    ...
    Ce(
        { target: "Array", stat: !0, forced: si },
        {
            from: function (t, e, n) {
                ...
                else for (s = (o = m.call(l)).next, r = new u(); !(a = s.call(o)).done; d++) Kn(r, d, f ? Un(o, h, [a.value, d], !0) : a.value);
                return (r.length = d), r;
            },
        }
    );
    ...
    u.SVGInjector(document.querySelectorAll("[data-inject-svg]"), {
        afterEach: function (t, e) {
            "function" == typeof jarallax && e.dispatchEvent(new CustomEvent("injected.mr.SVGInjector", { bubbles: !0 }));
        },
    });
    var li = (function (c) {
    ...
    !(function () {
        ...
        (t.mrMapsStyle = bt),
        (t.mrOverlayNav = At),
        (t.mrReadingPosition = kt),
        (t.mrSmoothScroll = Ot),
        (t.mrSticky = jt),
        (t.mrTwitterFetcher = li),
        (t.mrTypedText = ui),
        (t.mrUtil = B),
